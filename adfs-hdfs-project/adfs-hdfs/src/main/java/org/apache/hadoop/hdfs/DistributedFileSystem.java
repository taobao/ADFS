...
public class DistributedFileSystem extends FileSystem {
  ...
  /**
   * Invoke DFSClient's refreshLocalNameNodeList
   */
  public String refreshLocalNameNodeList() throws IOException{
    return DFSClient.refreshLocalNameNodeList();
  }
  
  /**
   * Invoke DFSClient's refreshLocalNameNode
   */
  public void refreshLocalNameNode() throws IOException{
