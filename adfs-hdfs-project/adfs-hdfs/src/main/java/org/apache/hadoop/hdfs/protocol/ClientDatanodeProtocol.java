...
public interface ClientDatanodeProtocol extends VersionedProtocol {
  ...
  /**
   * Ask data node to refresh its name node List
   * 
   * @return the refreshed name node list
   */
  String refreshNameNodeList() throws IOException;
  
  /**
   * Ask data node to refreshNameNode immediately
   */
