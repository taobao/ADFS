...
public class MysqlServerController {
  ...
  void setMysqlDefaultConf(Configuration conf) throws IOException {
    ...
    String dataPath = conf.get("mysql.server.data.path", ".");
    ...
    String mysqlServerPort = Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.port", "50001");
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.basedir", defaultMysqlBaseDir, true);
    conf.set("mysql.server.conf.mysqld.basedir", Utilities.getNormalPath(conf.get("mysql.server.conf.mysqld.basedir")));
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.datadir", dataPath, true);
    conf.set("mysql.server.conf.mysqld.datadir", Utilities.getNormalPath(conf.get("mysql.server.conf.mysqld.datadir")));
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.tmpdir", dataPath, true);
    conf.set("mysql.server.conf.mysqld.tmpdir", Utilities.getNormalPath(conf.get("mysql.server.conf.mysqld.tmpdir")));
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.socket", dataPath + "/mysqld.sock", true);
    conf.set("mysql.server.conf.mysqld.socket", Utilities.getNormalPath(conf.get("mysql.server.conf.mysqld.socket")));
    if (conf.get("mysql.server.conf.mysqld.socket").length() > 107)
      throw new IOException("socket file path is too long (>107): " + conf.get("mysql.server.conf.mysqld.socket"));
    ...
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.innodb_log_file_size", "5M");
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.innodb_log_buffer_size", "10M");
    ...
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.loose_tdh_socket_listen_port", Integer
        .valueOf(mysqlServerPort) + 3);
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.loose_tdh_socket_thread_num", "4");
    Utilities.setConfDefaultValue(conf, "mysql.server.conf.mysqld.loose_tdh_socket_write_thread_num", "4");
  }
