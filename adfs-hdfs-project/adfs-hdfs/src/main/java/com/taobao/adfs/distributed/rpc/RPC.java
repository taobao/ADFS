...
public class RPC {
  ...
  public static class Invocation implements Writable {
    ...
    private String proxyMethodName = null;
    private long elapsedTime = -1;
    protected int callerAddress = 0;
    ...
    protected DistributedOperation[] distributedOperations = null;
    ...
    public DistributedOperation[] setDistributedOperations(DistributedOperation[] distributedOperations) {
      assert distributedOperations != null : "distributedOperations is null";
      return this.distributedOperations = distributedOperations;
    }

    public DistributedOperation[] getDistributedOperations() {
      return distributedOperations;
    }
    ...
    public String setProxyMethodName(String proxyMethodName) {
      return this.proxyMethodName = proxyMethodName;
    }
    ...
    public void write(DataOutput out) throws IOException {
      ...
      ObjectWritable.writeObject(out, distributedOperations, DistributedOperation[].class);
    }
    ...
    public void readFields(DataInput in) throws IOException {
      ...
      distributedOperations = (DistributedOperation[]) ObjectWritable.readObject(in, null);
    }
      ...
      if (haveInvoked) {
        ...
        if (result == null) {
          try {
            ...
            if (returnType.equals(Void.class) || returnType.equals(Void.TYPE)) buffer
        ...
        if (distributedOperations != null)
          buffer.append(":").append(DistributedOperation.toString(distributedOperations));
        if (proxyMethodName != null) buffer.append("@").append(proxyMethodName);
      }
