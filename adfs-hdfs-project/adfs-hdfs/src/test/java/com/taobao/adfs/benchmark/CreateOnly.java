...
public class CreateOnly {
	...
	private static void runTest() throws IOException {
		...
		String parmInfo = "operation:create_write;"+"threadNum:"+threadNum+";blockSize:"+blockSize+
				";fileNumPerThread:"+fileNumPerThread+";interval:"+interval;
		output.printParamInfo(parmInfo);
		for(int i =0; i<threadNum; i++)
		{
			threads[i] = new Thread(new CreateThread(i, fs, blockSize, 
	...
	private static void displayUsage() {
		String usage =
			      ...
			      "\t-logPath <the full path of log file. default is ./create.log. " + "This is not mandatory>\n" +
