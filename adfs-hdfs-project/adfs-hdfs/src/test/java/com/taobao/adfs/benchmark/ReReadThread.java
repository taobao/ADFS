...
public class ReReadThread implements Runnable {
	...
	public ReReadThread(int threadIndex, FileSystem fs, CountDownLatch fire, 
								CountDownLatch over, Output output, String dirToRead, int timesPerThread)
	{
