 ...
 */
public class TestSNCrcCorruption extends TestCase {

	static private Configuration conf;
  static private MiniMNDFSCluster cluster;
  
  public TestSNCrcCorruption() {
    super();
...
//        }  
	...
	public void testDFSSingleNNCrcCorruption()throws Exception {
...
//	  thistest(util1,"0",3);
  ...
  public void testEntirelyCorruptFileOneDNAndOneNN() throws Exception {
  ...
  public void testEntirelyCorruptFileThreeDNAndOneNN() throws Exception {
    System.out.println("TestCrcCorruption: testEntirelyCorruptFileThreeDNAndOneNN");
    doTestEntirelyCorruptFile(3,"0");   
  }
