...
public class TestBlockManager {
  ...
  private void addNodes(Iterable<DatanodeDescriptor> nodesToAdd) throws IOException {
    NetworkTopology cluster = fsn.stateManager.clusterMap;
    ...
    for (DatanodeDescriptor dn : nodesToAdd) {
      ...
      assertNotNull(fsn.stateManager.getDatanodeDescriptorByDatanodeId(dn.getId()));
    }
  }
  ...
  private BlockInfo addBlockOnNodes(long blockId, List<DatanodeDescriptor> nodes) throws IOException {
    ...
    BlockInfo blockInfo = /*fsn.blocksMap.addINode(block, iNode)*/null;
  ...
  private DatanodeInfo[] scheduleSingleReplication(Block block) throws IOException {
