 ...
 */
public class TestSNFSOutputSummer extends TestCase {
  ...
  public void testFSOutputSummer() throws Exception {
    ...
    MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, NUM_OF_DATANODES, true, null);
    fileSys = cluster.getFileSystemCToFreeNamenode(-1);
    try {
