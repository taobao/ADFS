  ...
  public void testNodeCount() throws Exception {
    ...
    try {
      ...
      DatanodeDescriptor[] datanodes = /*(DatanodeDescriptor[])
         namesystem.heartbeats.toArray(new DatanodeDescriptor[REPLICATION_FACTOR])*/null;
...
//     }
      ...
      Iterator<DatanodeDescriptor> iter = /*namesystem.blocksMap.nodeIterator(block)*/null;
