 ...
 */
public class TestSNFileAppend extends TestCase {
  {
  ...
  private String namenodeliststr = "0";
  //
  // create a buffer that contains the entire test file data.
  //
  private void initBuffer(int size) {
    seed = SNAppendTestUtil.nextLong();
  ...
  public void testCopyOnWrite() throws Exception {
   Configuration conf = new Configuration();
    ...
    //Set single namenode
    conf.setStrings("dfs.namenode.port.list", this.namenodeliststr);
