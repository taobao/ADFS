 ...
 */
public class TestMNFileConcurrentReader extends junit.framework.TestCase {
  ...
  private static final Logger LOG = 
    Logger.getLogger(TestMNFileConcurrentReader.class);
...
//    byte[] buffer = SNAppendTestUtil.randomBytes(seed, size);
  ...
  public void testUnfinishedBlockRead()
    ...
    try {
      ...
      FSDataOutputStream stm = TestMNFileCreation.createFile(fileSystem, file1, 1);
  ...
  public void testUnfinishedBlockPacketBufferOverrun() throws IOException {
    try {
      ...
      // create a new file in the root, write data, do no close
      Path file1 = new Path("/unfinished-block");
      final FSDataOutputStream stm = TestMNFileCreation.createFile(fileSystem, file1, 1);
