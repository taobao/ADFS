 ...
 */
public class TestSNFileAppend4 extends TestCase {
  static final Log LOG = LogFactory.getLog(TestSNFileAppend4.class);
...
//    conf.set("dfs.replication.pending.timeout.sec", Integer.toString(5));
  ...
  public void testRecoverFinalizedBlock() throws Throwable {
    ...
    try {
      ...
      FileSystem fs1 = cluster.getFileSystemCToFreeNamenode(-1);
      FileSystem fs2 = SNAppendTestUtil.createHdfsWithDifferentUsername(
        fs1.getConf());
