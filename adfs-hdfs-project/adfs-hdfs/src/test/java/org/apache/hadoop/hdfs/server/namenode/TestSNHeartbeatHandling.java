 ...
 */
public class TestSNHeartbeatHandling extends TestCase {
  /**
   ...
   */
  private static final Log LOG = LogFactory.getLog(TestSNHeartbeatHandling.class);
  ...
  public void testHeartbeat() throws Exception {
    ...
    LOG.info("^^^^^^^^^^"+conf);
    final MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, 1, true, null);
    try {
      cluster.waitActive();
