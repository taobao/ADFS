 ...
 */
public class TestMNFileCreationClient extends junit.framework.TestCase {
  static final String DIR = "/" + TestMNFileCreationClient.class.getSimpleName() + "/";
  ...
  public void testClientTriggeredLeaseRecovery() throws Exception {
    ...
    MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, REPLICATION, 1, true, null);
    cluster.waitActive();
