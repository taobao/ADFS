 ...
 */
public class TestSNSmallBlock extends TestCase {
  static final long seed = 0xDEADBEEFL;
  static final int blockSize = 1;
  static final int fileSize = 20;
  boolean simulatedStorage = false;

  private String namenodestr = "0";
   ...
   */
  public void smallBlockTest() throws IOException {
  ...
  public void smallBlockSimulatedStorageTest() throws IOException {
    simulatedStorage = true;
    smallBlockTest();
    simulatedStorage = false;
  }
  
  public void testSingleNamenodeSmallBlock() throws IOException {
    namenodestr = "0";
    smallBlockTest();
    smallBlockSimulatedStorageTest();
  }
}
