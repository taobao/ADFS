 ...
 */
public class TestSNFileConcurrentReader extends junit.framework.TestCase {
  ...
  private static final Logger LOG = 
    Logger.getLogger(TestSNFileConcurrentReader.class);
  ...
  private void init(Configuration conf) throws IOException {
    ...
    cluster.waitActive();
    fileSystem = cluster.getFileSystemCToFreeNamenode(-1);
  }
...
//    byte[] buffer = AppendTestUtil.randomBytes(seed, size);
  ...
  public void testUnfinishedBlockRead()
    ...
    try {
      ...
      FSDataOutputStream stm = TestSNFileCreation.createFile(fileSystem, file1, 1);
  ...
  public void testUnfinishedBlockPacketBufferOverrun() throws IOException {
    try {
      ...
      // create a new file in the root, write data, do no close
      Path file1 = new Path("/unfinished-block");
      final FSDataOutputStream stm = TestSNFileCreation.createFile(fileSystem, file1, 1);
