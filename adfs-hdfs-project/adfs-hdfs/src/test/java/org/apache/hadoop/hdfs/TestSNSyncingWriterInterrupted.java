...
public class TestSNSyncingWriterInterrupted {
  static final Log LOG = LogFactory.getLog(TestSNSyncingWriterInterrupted.class);
  ...
  public void testWriterInterrupted() throws Exception {
    short repl = 3;
    int numWrites = 200000;
    
    MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, repl, true, null);
    cluster.waitActive();
