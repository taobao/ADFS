 ...
 */
public class TestSNDataBlockScanner extends junit.framework.TestCase {
  ...
  public void testPrematureDataBlockScannerAdd() throws IOException, InterruptedException {
    // check that / exists
    Path path = new Path("/");
