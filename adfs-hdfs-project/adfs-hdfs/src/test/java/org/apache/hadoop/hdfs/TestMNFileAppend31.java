...
public class TestMNFileAppend31 extends junit.framework.TestCase {
...
//    return new TestSetup(new TestSuite(TestMNFileAppend31.class)) {
...
//        cluster = new MiniMNDFSCluster(conf, DATANODE_NUM-1, 0, true, null);
  ...
  public void testTC11() throws Exception {
    ...
    for(int i = 0; i < numblock; i++) {
      ...
      for(DatanodeInfo datanodeinfo : lb.getLocations()) {
        ...
        if(dn==null)
        {
        	System.out.println("ipcPort: "+datanodeinfo.getIpcPort());
        	for(DataNode oneDN: cluster.getDataNodes())
        	{
        		System.out.println(oneDN.toString());
        	}
        }
