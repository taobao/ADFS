 ...
 */
public class TestMNFileCorruption extends TestCase {
  
  public TestMNFileCorruption(String testName) {
    super(testName);
  }
  ...
  public void testFileCorruption() throws Exception {
    ...
    try {
      ...
      //System.setProperty("test.build.data", "/home/hxq/hadoop-new/NN-refactor-split-ns-blocksmap.zk/build/test/data/");
      File data_dir = new File(System.getProperty("test.build.data", "build/test/data"), "dfs/data/data5/current");
  ...
  public void testLocalFileCorruption() throws Exception {
    Configuration conf = new Configuration();
    //System.setProperty("test.build.data", "/home/hxq/hadoop-new/NN-refactor-split-ns-blocksmap.zk/build/test/data/");
    Path file = new Path(System.getProperty("test.build.data", "build/test/data"), "corruptFile");
  ...
  public void testArrayOutOfBoundsException() throws Exception {
    ...
    try {
      ...
      cluster.getNameNode(0).namesystem.markBlockAsCorrupt(blk, new DatanodeInfo(dataNode.dnRegistration ));
