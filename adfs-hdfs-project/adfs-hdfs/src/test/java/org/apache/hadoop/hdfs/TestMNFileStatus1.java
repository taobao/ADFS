 ...
 */
public class TestMNFileStatus1 extends TestCase {
  static final long seed = 0xDEADBEEFL;
  static final int blockSize = 8192;
  static final int fileSize = 16384;

  private String namenodestr = "0,0";
  ...
  public void fileStatusTest(int mod) throws IOException {
    ...
    if(mod ==1) 
    	...
    	dfsClient = new DFSClient(cluster.getNameNode(1).getNameNodeAddress(), conf);
    try {
  ...
  public void testSingleNamenodeFileStatus1() throws IOException {
    this.namenodestr = "0,0";
    this.fileStatusTest(1);
  }
  
  public void testSingleNamenodeFileStatus2() throws IOException {
    this.namenodestr = "0,0";
    this.fileStatusTest(2);
  }
}
