 ...
 */
public class TestSNFileCreationEmpty extends junit.framework.TestCase {
  ...
  public void testLeaseExpireEmptyFiles() throws Exception {
    ...
    try {
      ...
      // create a new file.
      TestSNFileCreation.createFile(dfs, new Path("/foo"), DATANODE_NUM);
      TestSNFileCreation.createFile(dfs, new Path("/foo2"), DATANODE_NUM);
      TestSNFileCreation.createFile(dfs, new Path("/foo3"), DATANODE_NUM);
