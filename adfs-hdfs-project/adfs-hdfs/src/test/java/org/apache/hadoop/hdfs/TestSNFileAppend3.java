...
public class TestSNFileAppend3 extends junit.framework.TestCase {
  ...
  protected void setUp() throws java.lang.Exception {
    ...
    cluster = new MiniMNDFSCluster(conf, DATANODE_NUM, true, null);
    cluster.waitActive();
    fs = (DistributedFileSystem)cluster.getFileSystemCToFreeNamenode(-1);
  }
  ...
  public void testTC12() throws Exception {
    ...
    //recover the normal lease expire settings
    cluster.setLeasePeriod(60*1000, 60*60*1000);
