 ...
 */
public class TestMNDFSClientRetries extends TestCase {
  public static final Log LOG =
    LogFactory.getLog(TestMNDFSClientRetries.class.getName());
  ...
  class TestNameNode implements ClientProtocol
  {
    ...
    public boolean recoverLease(String src, String clientName) throws IOException { return false;}
...
//TODO:
  ...
  public void testFailuresArePerOperation() throws Exception
  {
    ...
    try {
      ...
      cluster.waitDatanodeDie();
      FileSystem fs = cluster.getFileSystem(1);
      NameNode preSpyNN = cluster.getNameNode(1);
