 ...
 */
public class TestMNDecommission extends TestCase {
  ...
  private String decommissionNode(NameNode namenode,
    ...
    /*for(int i=0;i<cluster.getNameNodes().size();i++){
      cluster.getNameNode(i).namesystem.updateHeartbeatInBatchForBM();      
    }
    for(int i=0;i<cluster.getNameNodes().size();i++){
      cluster.getNameNode(i).namesystem.updateDatanodesMap(true);      
    }*/
    ...
    /*for(NameNode nn : namenodes){
      nn.namesystem.refreshNodes(conf);
      break;
    }*/
...
//    conf.setInt("datanodemap.update.interval", 1200);
...
//
//    MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, numDatanodes, 0, true, null);
//    cluster.waitActive();
//    //cluster.getNameNode(1).namesystem.stallReplicationWork();
//    
//    DatanodeInfo[] info = cluster.getDataNodeReportType(DatanodeReportType.LIVE);
//    assertEquals("Number of Datanodes ", numDatanodes, info.length);
//    //FileSystem fileSys = cluster.getFileSystemCToFreeNamenode(0);
...
//        // 
//        Path file1 = new Path("decommission.dat"+iteration);
//        writeFile(fileSys, file1, replicas);
//        System.out.println("Created file decommission.dat with " +
//                           replicas + " replicas.");
//        //fileSys.setReplication(file1, (short)replicas);
//        checkFile(fileSys, file1, replicas);
//        printFileLocations(fileSys, file1);
//        String downnode = decommissionNode(cluster.getNameNode(0), conf,
//                                           cluster, localFileSys);
...
//      }
//    } catch (IOException e) {
//      info = cluster.getDataNodeReportType(DatanodeReportType.ALL);
