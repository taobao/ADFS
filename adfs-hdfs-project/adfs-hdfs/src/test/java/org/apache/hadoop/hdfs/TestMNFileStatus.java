 ...
 */
public class TestMNFileStatus extends TestCase {
  static final long seed = 0xDEADBEEFL;
  static final int blockSize = 8192;
  static final int fileSize = 16384;

  private String namenodestr = "0,0,0";
  ...
  public void fileStatusTest() throws IOException {
    ...
    final DFSClient dfsClient = new DFSClient(cluster.getFreeNamenode(-1), conf);
    try {
  ...
  public void testSingleNamenodeFileStatus() throws IOException {
    this.namenodestr = "0";
    this.fileStatusTest();
  }
  
  public void testMultiNamenodeFileStatus() throws IOException {
    this.namenodestr = "0,0,0";
    this.fileStatusTest();
  }
}
