...
import org.apache.hadoop.hdfs.server.datanode.TestSNInterDatanodeProtocol;
import org.apache.hadoop.hdfs.server.datanode.FSDatasetTestUtil;

import org.apache.hadoop.hdfs.server.protocol.BlockMetaDataInfo;
import org.apache.hadoop.hdfs.server.protocol.InterDatanodeProtocol;

public class TestSNLeaseRecovery extends junit.framework.TestCase {
  static final int BLOCK_SIZE = 1024;
  static final short REPLICATION_NUM = (short)3;

  static void checkMetaInfo(Block b, InterDatanodeProtocol idp
      ) throws IOException {
    TestSNInterDatanodeProtocol.checkMetaInfo(b, idp, null);
  }
  ...
  throws Exception {
    ...
    try {
      cluster = new MiniMNDFSCluster(conf, 5, true, null);
      cluster.waitActive();

      //create a file
      int fs_nnindex = 0;//+
      DistributedFileSystem dfs = (DistributedFileSystem)cluster.getFileSystem(fs_nnindex);
      String filestr = "/foo";
      ...
      LocatedBlock locatedblock = TestSNInterDatanodeProtocol.getLastLocatedBlock(
      ...
      cluster.getNameNode(fs_nnindex).append(filestr, dfs.dfs.clientName);
      ...
      long currentGS = cluster.getNameNode(fs_nnindex).namesystem.getGenerationStamp();//m
