 ...
 */
public class TestSNRestartDFS extends TestCase {
  ...
  public void testRestartDFS() throws Exception {
    ...
    try {
      ...
      if (cluster != null) { cluster.shutdown(false); }
    }
    try {
      // Here we restart the MiniDFScluster without formatting namenode
      cluster = new MiniMNDFSCluster(conf, 4, false, null, false);
      FileSystem fs = cluster.getFileSystemCToFreeNamenode(-1);
      assertTrue("Filesystem corrupted after restart.",
                 files.checkFiles(fs, dir));

      //TODO: add ugi test after impli
      /*
