...
public class TestSNDistributedFileSystem extends junit.framework.TestCase {
  ...
  public void testFileSystemCloseAll() throws Exception {
    ...
    MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, 0, true, null);
  ...
  public void testDFSClose() throws Exception {
    ...
    FileSystem fileSys = cluster.getFileSystemCToFreeNamenode(-1);
  ...
  public void xxxtestFileChecksum() throws IOException {
    ...
    final MiniMNDFSCluster cluster = new MiniMNDFSCluster(conf, 2, true, null);
