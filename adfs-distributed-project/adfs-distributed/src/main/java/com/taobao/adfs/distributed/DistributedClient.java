...
public class DistributedClient implements Closeable, InvocationHandler {
  ...
  static public void close(Object distributedClient) throws IOException {
  ...
  public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    invocation.setCallerOfCallerAddress(org.apache.hadoop.ipc.Server.getRemoteAddress());
    ...
    Class<?> operationType = DistributedData.getDistributedInvocationType(method);
    if (operationType != DistributedRead.class && operationType != DistributedWrite.class)
      throw new IOException("no or wrong operation annotation for " + invocation.getMethod().toGenericString());
    boolean isReadOperation = operationType == DistributedRead.class;
    ...
    for (int i = 0; i < retryNumber; ++i) {
      try {
        ...
        Utilities.logDebug(logger, "request ", masterServer.name, " to do ", isReadOperation ? "read" : "write",
            " call ", invocation);
        ...
        if (t instanceof RemoteException
          ...
          Utilities.logInfo(logger, "request ", masterServer.name, " to do ", isReadOperation ? "read" : "write",
              " call ", invocation, " exception=", t);
          throw t;
        }
        Utilities.logWarn(logger, "fail to request ", masterServer.name, " to do ", isReadOperation ? "read" : "write",
            " call ", invocation, ", retryIndex=", i, ", maxRetryIndex=", retryNumber - 1, " exception=", t);
