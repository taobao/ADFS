...
public class DistributedElement {
  ...
  public String setOperateIdentifier() {
    ...
    operateIdentifier = currentInvocation == null ? null : currentInvocation.getOperateIdentifier();
  ...
  public boolean isOperateIdentifierMatched() {
    Invocation currentInvocation = DistributedServer.getCurrentInvocation();
    String currentOperateIdentifier = currentInvocation == null ? null : currentInvocation.getOperateIdentifier();
