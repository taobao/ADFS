...
public class DistributedException extends IOException {
  ...
  public DistributedException(Object resultForServer, Throwable t) {
    super(t);
    this.resultForServer = resultForServer;
  }
  ...
  static public Object getDistributedExceptionResult(Throwable t) {
    while (true) {
      if (t instanceof DistributedException) return ((DistributedException) t).resultForServer;
      t = t.getCause();
