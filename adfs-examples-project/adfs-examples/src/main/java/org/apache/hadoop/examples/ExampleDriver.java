...
public class ExampleDriver {
  ...
  public static void main(String argv[]){
    ...
    try {
      ...
      pgd.addClass("seqappend", SequenceFileAppendSyncTest.class, "append & sync file.");
      pgd.addClass("appendfile", AppendFileDFSClient.class, "append & sync file.");
      pgd.addClass("zkrunner", ZKRunner.class, "A zkclient benchmark tester.");
      pgd.driver(argv);
